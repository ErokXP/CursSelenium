...
public class CssSelectorExample extends BaseTest {
	...
	public void cssExample1() {
		...
		// CssSelector pentru attribute class --> .
		// .menu_main_nav_area
		...
		// ul[id='menu_user'] --> gaseste doar elementele care au tagname 'ul si id (#) cu valoarea 'menu)user'
		// ul --> tagname
		// id (#) --> atribut
	...
	public void cssExample4() throws InterruptedException {
		...
		* nu mai fac referinte cu > (direct child) ci pun doar spatiu ' ' 
